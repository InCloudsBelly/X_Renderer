...
namespace X {
    ...
    namespace Terrain {
        ...
        TerrainStorage::TerrainStorage(int32_t rootNodeCount, int32_t LoDCount, float sideLength,
            ...
            baseColorMaps = X::Texture::Texture2DArray(materialResolution,
                materialResolution, materialCount, VK_FORMAT_R8G8B8A8_UNORM,
                Texture::Wrapping::Repeat, Texture::Filtering::Anisotropic);
            roughnessMaps = X::Texture::Texture2DArray(materialResolution,
                materialResolution, materialCount, VK_FORMAT_R8_UNORM,
                Texture::Wrapping::Repeat, Texture::Filtering::Anisotropic);
            aoMaps = X::Texture::Texture2DArray(materialResolution,
                materialResolution, materialCount, VK_FORMAT_R8_UNORM,
                Texture::Wrapping::Repeat, Texture::Filtering::Anisotropic);
            normalMaps = X::Texture::Texture2DArray(materialResolution,
                materialResolution, materialCount, VK_FORMAT_R8G8B8A8_UNORM,
                Texture::Wrapping::Repeat, Texture::Filtering::Anisotropic);
            displacementMaps = X::Texture::Texture2DArray(materialResolution,
                materialResolution, materialCount, VK_FORMAT_R8_UNORM,
                Texture::Wrapping::Repeat, Texture::Filtering::Anisotropic);
