...
#define X_WINDOWPOSITION_UNDEFINED SDL_WINDOWPOS_UNDEFINED

#define X_WINDOW_FULLSCREEN    SDL_WINDOW_FULLSCREEN
#define X_WINDOW_SHOWN            SDL_WINDOW_SHOWN
#define X_WINDOW_HIDDEN        SDL_WINDOW_HIDDEN
#define X_WINDOW_BORDERLESS    SDL_WINDOW_BORDERLESS
#define X_WINDOW_RESIZABLE        SDL_WINDOW_RESIZABLE
#define X_WINDOW_MINIMIZED        SDL_WINDOW_MINIMIZED
#define X_WINDOW_MAXIMIZED        SDL_WINDOW_MAXIMIZED
#define X_WINDOW_HIGH_DPI        SDL_WINDOW_ALLOW_HIGHDPI
...
namespace X {
    ...
    public:
        ...
        Window(const std::string& title, int32_t x, int32_t y, int32_t width, int32_t height,
               int32_t flags = X_WINDOW_FULLSCREEN, bool createSurface = true);
