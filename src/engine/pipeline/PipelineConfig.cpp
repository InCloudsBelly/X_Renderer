...
namespace X {
    ...
    PipelineConfig::PipelineConfig(const std::string& debugName, const ShaderConfig& shaderConfig, const Graphics::GraphicsPipelineDesc& desc) :
        debugName(debugName), shaderConfig(shaderConfig), graphicsPipelineDesc(desc), isCompute(false) {
    ...
    PipelineConfig::PipelineConfig(const std::string& debugName, const ShaderConfig& shaderConfig, const Graphics::GraphicsPipelineDesc& desc,
        const std::vector<std::string>& macros) : debugName(debugName), shaderConfig(shaderConfig), macros(macros),
    ...
    PipelineConfig::PipelineConfig(const std::string& debugName, const std::string& shaderFile) : debugName(debugName), isCompute(true) {
    ...
    PipelineConfig::PipelineConfig(const std::string& debugName, const std::string& shaderFile, const std::vector<std::string>& macros) :
        debugName(debugName), macros(macros), isCompute(true) {
