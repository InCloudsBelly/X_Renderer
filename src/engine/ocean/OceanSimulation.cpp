...
namespace X {
    ...
    namespace Ocean {
        ...
        OceanSimulation::OceanSimulation(int32_t N, int32_t L) : N(N), L(L) {
            ...
            h0Config = PipelineConfig("OceanSim_H0_Pipeline", "ocean/h0.csh");
            htConfig = PipelineConfig("OceanSim_HT_Pipeline","ocean/ht.csh");
            twiddleConfig = PipelineConfig("OceanSim_twiddleIndices_Pipeline","ocean/twiddleIndices.csh");
            horizontalButterflyConfig = PipelineConfig("OceanSim_Butterfly_Pipeline","ocean/butterfly.csh");
            verticalButterflyConfig = PipelineConfig("OceanSim_Butterfly_Pipeline","ocean/butterfly.csh");
            inversionConfig = PipelineConfig("OceanSim_Inversion_Pipeline","ocean/inversion.csh");
            normalConfig = PipelineConfig("OceanSim_Normal_Pipeline","ocean/normal.csh");
