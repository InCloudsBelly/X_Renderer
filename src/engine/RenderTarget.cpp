...
namespace X {
    ...
    RenderTarget::RenderTarget(int32_t width, int32_t height) : width(width), height(height) {
...

        {
            Graphics::RenderPassColorAttachment colorAttachments[] = {
                ...
                {.imageFormat = targetData.emissionTexture->format},
            ...
            auto gBufferRenderPassDesc = Graphics::RenderPassDesc{
                .colorAttachments = {colorAttachments[0], colorAttachments[1], colorAttachments[2],
                                     colorAttachments[3], colorAttachments[4], colorAttachments[5], colorAttachments[6], colorAttachments[7]},
    ...
    void RenderTarget::Swap() {
        ...
        gBufferFrameBuffer->ChangeColorAttachmentImage(targetData.velocityTexture->image, 6);
    ...
    void RenderTarget::SetVolumetricResolution(RenderResolution resolution) {
        ...
        froxelInjectionGrid = Texture::Texture3D(VOXEL_GRID_SIZE_X, VOXEL_GRID_SIZE_Y, VOXEL_GRID_SIZE_Z, VK_FORMAT_R16G16B16A16_SFLOAT, 
            Texture::Wrapping::ClampToEdge, Texture::Filtering::Linear);
        histroyFroxelInjectionGrid = Texture::Texture3D(VOXEL_GRID_SIZE_X, VOXEL_GRID_SIZE_Y, VOXEL_GRID_SIZE_Z, VK_FORMAT_R16G16B16A16_SFLOAT, 
            Texture::Wrapping::ClampToEdge, Texture::Filtering::Linear);
        froxelScatteringGrid = Texture::Texture3D(VOXEL_GRID_SIZE_X, VOXEL_GRID_SIZE_Y, VOXEL_GRID_SIZE_Z, VK_FORMAT_R16G16B16A16_SFLOAT, 
            Texture::Wrapping::ClampToEdge, Texture::Filtering::Linear);
    ...
    void RenderTarget::CreateFrameBuffers() {
        ...
        auto gBufferFrameBufferDesc = Graphics::FrameBufferDesc{
               ...
               .colorAttachments = {
                   ...
                   {targetData.emissionTexture->image, 0, true},
