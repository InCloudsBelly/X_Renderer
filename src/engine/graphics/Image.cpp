    ...
    namespace Graphics {
        ...
        Image::Image(GraphicsDevice *device, const ImageDesc &desc) : aspectFlags(desc.aspectFlags),
            ...
            if (desc.type == ImageType::Image1DArray || desc.type == ImageType::Image2DArray ||
                desc.type == ImageType::ImageCube || desc.type == ImageType::ImageCubeArray) {
                imageInfo.arrayLayers = desc.layers;
            }
            if (desc.type == ImageType::ImageCube || desc.type == ImageType::ImageCubeArray) {
            ...
            switch(desc.type) {
                ...
                case ImageType::ImageCubeArray: viewType = VK_IMAGE_VIEW_TYPE_CUBE_ARRAY; break;
            ...
            if (desc.type != ImageType::ImageCube) {
                ...
                switch (GetImageType()) {
                case VK_IMAGE_TYPE_1D :imageViewInfo.viewType = VK_IMAGE_VIEW_TYPE_1D; break;
                case VK_IMAGE_TYPE_2D :imageViewInfo.viewType = VK_IMAGE_VIEW_TYPE_2D; break;
                case VK_IMAGE_TYPE_3D :imageViewInfo.viewType = VK_IMAGE_VIEW_TYPE_3D; break;
                }
