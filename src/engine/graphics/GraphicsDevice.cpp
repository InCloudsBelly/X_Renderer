...
namespace X {
    ...
    namespace Graphics {
        ...
        QueueRef GraphicsDevice::GetAndLockQueue(X::Graphics::QueueType queueType) {
        ...
        void GraphicsDevice::SetDebugUtilsObjectName(const VkObjectType objectType, const std::string& name, const void* handle)
        {
