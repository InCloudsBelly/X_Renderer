...
namespace X {
    ...
    namespace Renderer {
        ...
        void AtmosphereRenderer::Init(Graphics::GraphicsDevice *device) {
            ...
            defaultPipelineConfig = PipelineConfig("Atmosphere_Default_Pipeline","atmosphere.csh");
            cubeMapPipelineConfig = PipelineConfig("Atmosphere_CubeMap_Pipeline", "atmosphere.csh", {"ENVIRONMENT_PROBE"});
