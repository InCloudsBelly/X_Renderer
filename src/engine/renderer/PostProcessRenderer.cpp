...
namespace X {
    ...
    namespace Renderer {
        ...
        void PostProcessRenderer::Init(Graphics::GraphicsDevice *device) {
            ...
            sharpenPipelineConfig = PipelineConfig("Sharpen_Pilepine","sharpen.csh");
        ...
        PipelineConfig PostProcessRenderer::GetMainPipelineConfig() {
            ...
            return PipelineConfig("Postprocessing_Pipeline", shaderConfig, pipelineDesc, macros);
        ...
        PipelineConfig PostProcessRenderer::GetMainPipelineConfig(const Ref<Graphics::FrameBuffer> frameBuffer) {
            ...
            return PipelineConfig("Postprocessing_Pipeline", shaderConfig, pipelineDesc);
