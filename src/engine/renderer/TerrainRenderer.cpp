    ...
    namespace Renderer {
        ...
        PipelineConfig TerrainRenderer::GeneratePipelineConfig(RenderTarget *target,
            ...
            if (detailConfig) {
                ...
                return !materialMappingConfig ? PipelineConfig("Terrain_Pipeline",shaderConfig, pipelineDesc) :
                    PipelineConfig("Terrain_Pipeline", shaderConfig, pipelineDesc, {"MATERIAL_MAPPING"});
            }
            else {
                const auto shaderConfig = ShaderConfig{
                    {"terrain/terrain.vsh",  VK_SHADER_STAGE_VERTEX_BIT},
                ...
                return !materialMappingConfig ? PipelineConfig("Terrain_Pipeline", shaderConfig, pipelineDesc, {"DISTANCE"}) :
                       PipelineConfig("Terrain_Pipeline", shaderConfig, pipelineDesc, {"DISTANCE", "MATERIAL_MAPPING"});
            }
