...
namespace X {
    ...
    namespace Renderer {
        ...
        void DDGIRenderer::Init(Graphics::GraphicsDevice *device) {
            ...
            rayGenPipelineConfig = PipelineConfig("DDGI_RayGen_Pipeline", "ddgi/rayGen.csh");
            rayHitPipelineConfig = PipelineConfig("DDGI_RayHit_Pipeline", "ddgi/rayHit.csh");

            probeStatePipelineConfig = PipelineConfig("DDGI_ProbeState_Pipeline", "ddgi/probeState.csh");
            probeIrradianceUpdatePipelineConfig = PipelineConfig("DDGI_ProbeIrradianceUpdate_Pipeline", "ddgi/probeUpdate.csh", {"IRRADIANCE"});
            probeMomentsUpdatePipelineConfig = PipelineConfig("DDGI_ProbeMomentsUpdate_Pipeline", "ddgi/probeUpdate.csh");
            irradianceCopyEdgePipelineConfig = PipelineConfig("DDGI_IrradianceCopyEdge_Pipeline", "ddgi/copyEdge.csh", {"IRRADIANCE"});
            momentsCopyEdgePipelineConfig = PipelineConfig("DDGI_MomentsCopyEdge_Pipeline", "ddgi/copyEdge.csh");
        ...
        void DDGIRenderer::DebugProbes(Viewport* viewport, RenderTarget* target, Camera* camera,
            ...
            auto pipelineConfig = PipelineConfig("DDGI_ProbeDebug_Pipeline",shaderConfig, pipelineDesc);
