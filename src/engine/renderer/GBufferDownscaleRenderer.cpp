...
namespace X {
    ...
    namespace Renderer {
        ...
        void GBufferDownscaleRenderer::Init(Graphics::GraphicsDevice *device) {
            ...
            downscalePipelineConfig = PipelineConfig("DownScale_GBuffer_Pipeline", "downsampleGBuffer2x.csh");
            downscaleDepthOnlyPipelineConfig = PipelineConfig("DownScale_GBufferDepthOnly_Pipeline", "downsampleGBuffer2x.csh", {"DEPTH_ONLY"});
