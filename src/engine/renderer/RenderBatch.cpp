...
namespace X {
    ...
    namespace Renderer {
        ...
        RenderBatch::RenderBatch() {
            ...
            /*
            lineVertices = X::Buffer::VertexBuffer(GL_FLOAT,
                3, sizeof(vec3), 0, nullptr, X_BUFFER_DYNAMIC_STORAGE);
            lineColors = X::Buffer::VertexBuffer(GL_FLOAT,
                3, sizeof(vec3), 0, nullptr, X_BUFFER_DYNAMIC_STORAGE);
            ...
            triangleVertices = X::Buffer::VertexBuffer(GL_FLOAT,
                3, sizeof(vec3), 0, nullptr, X_BUFFER_DYNAMIC_STORAGE);
            triangleColors = X::Buffer::VertexBuffer(GL_FLOAT,
                3, sizeof(vec3), 0, nullptr, X_BUFFER_DYNAMIC_STORAGE);
