...
namespace X {
    ...
    namespace Renderer {
        ...
        void AORenderer::Init(Graphics::GraphicsDevice *device) {
            ...
            ssaoPipelineConfig = PipelineConfig("SSAO_Pipeline","ao/ssao.csh");
            rtaoPipelineConfig = PipelineConfig("RTAO_Pipeline", "ao/rtao.csh");
            temporalPipelineConfig = PipelineConfig("AO_Temperal_Pipeline", "ao/temporal.csh");

            horizontalBlurPipelineConfig = PipelineConfig("AO_Horizontal_Blur_Pipeline","bilateralBlur.csh",
                {"HORIZONTAL", "DEPTH_WEIGHT","NORMAL_WEIGHT" });
            verticalBlurPipelineConfig = PipelineConfig("AO_Vertical_Blur_Pipeline", "bilateralBlur.csh",
