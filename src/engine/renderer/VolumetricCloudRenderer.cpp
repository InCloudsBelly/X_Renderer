...
namespace X {
    ...
    namespace Renderer {
        ...
        void VolumetricCloudRenderer::Init(Graphics::GraphicsDevice *device) {
            ...
            shapeNoisePipelineConfig = PipelineConfig("Clouds_ShapeNoise_Pipeline", "clouds/shapeNoise.csh");
            detailNoisePipelineConfig = PipelineConfig("Clouds_DetailNoise_Pipeline","clouds/detailNoise.csh");
            integratePipelineConfig = PipelineConfig("Clouds_Integrate_Pipeline","clouds/integrate.csh");
            temporalPipelineConfig = PipelineConfig("Clouds_Temporal_Pipeline","clouds/temporal.csh");
            shadowPipelineConfig = PipelineConfig("Clouds_Shadow_Pipeline","clouds/shadow.csh");
