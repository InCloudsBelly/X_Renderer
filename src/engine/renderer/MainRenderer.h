#ifndef X_MAINRENDERER_H
#define X_MAINRENDERER_H
    ...
    namespace Renderer {
        ...
        private:
            ...
            struct alignas(16) PointLightUniforms {
                ...
                glm::vec3 Padding{};
                PointLight PointLights[MAX_POINTLIGHT_SHADOW_COUNT];
            };
            ...
            Ref<Buffer::UniformBuffer> pointLightsUniformBuffer;
            ...
            LightCullingRenderer lightcullingRenderer;
