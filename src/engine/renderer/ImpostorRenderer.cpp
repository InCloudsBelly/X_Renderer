...
namespace X {
    ...
    namespace Renderer {
        ...
        void ImpostorRenderer::Generate(X::Viewport *viewport, const std::vector<mat4> &viewMatrices,
            ...
            for (size_t i = 0; i < viewMatrices.size(); i++) {
                ...
                for (size_t j = 0; j < mesh->data.subData.size(); j++) {
                    ...
                    if (material->HasEmissionMap())
                        commandList->BindImage(material->emissionMap->image, material->emissionMap->sampler, 3, 7);
        ...
        PipelineConfig ImpostorRenderer::GetPipelineConfig(Ref<Graphics::FrameBuffer> &frameBuffer,
            ...
            return PipelineConfig("Impostor_Pipeline", shaderConfig, pipelineDesc, macros);
        ...
        PipelineConfig ImpostorRenderer::GetPipelineConfigForSubData(Mesh::MeshSubData *subData,
            ...
            return PipelineConfig("Impostor_Generate_Pipeline", shaderConfig, pipelineDesc, macros);
