...
namespace X {
    ...
    namespace Renderer {
        ...
        VegetationRenderer::VegetationRenderer() {
            ...
            /*
            depthShader.AddStage(X_VERTEX_STAGE, "vegetation/depth.vsh");
            depthShader.AddStage(X_FRAGMENT_STAGE, "vegetation/depth.fsh");
        ...
        PipelineConfig VegetationRenderer::GetPipelineConfigForSubData(Mesh::MeshSubData *subData,
            ...
            return PipelineConfig("Vegetation_Pipeline",shaderConfig, pipelineDesc, macros);
