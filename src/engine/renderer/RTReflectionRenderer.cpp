...
namespace X {
    ...
    namespace Renderer {
        ...
        void RTReflectionRenderer::Init(Graphics::GraphicsDevice* device) {
            ...
            rtrPipelineConfig = PipelineConfig("RTReflection_Pipeline", "reflection/rtreflection.csh");
            temporalPipelineConfig = PipelineConfig("Reflection_Temperal_Pipeline", "reflection/temporal.csh");

            atrousPipelineConfig[0] = PipelineConfig("Reflection_Atrous_Pipeline1", "reflection/atrous.csh", { "STEP_SIZE1" });
            atrousPipelineConfig[1] = PipelineConfig("Reflection_Atrous_Pipeline2","reflection/atrous.csh", { "STEP_SIZE2" });
            atrousPipelineConfig[2] = PipelineConfig("Reflection_Atrous_Pipeline3","reflection/atrous.csh", { "STEP_SIZE4" });
