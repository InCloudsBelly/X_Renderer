    ...
    namespace Renderer {
        ...
        namespace Helper {
            ...
            RayTracingHelper::RayTracingHelper() {
                ...
                traceDispatchPipelineConfig = PipelineConfig("RTDispatch_Pipeline","raytracer/traceDispatch.csh");
                traceClosestPipelineConfig = PipelineConfig("TraceClosest_Pipeline","raytracer/traceClosest.csh");
                traceAnyPipelineConfig = PipelineConfig("TraceAny_Pipeline","raytracer/traceAny.csh");

                binningOffsetPipelineConfig = PipelineConfig("RTBinning_Pipeline","raytracer/binning.csh");
                binningPipelineConfig = PipelineConfig("RTBinningOffset_Pipeline","raytracer/binningOffset.csh");
            ...
            void RayTracingHelper::DispatchAndHit(Graphics::CommandList* commandList,
                ...
                // Bind textures and buffers
                {
                    ...
                    if (rtData.emissionTextureAtlas.slices.size())
                        commandList->BindImage(rtData.emissionTextureAtlas.textureArray.image,
                            rtData.emissionTextureAtlas.textureArray.sampler, 2, 29);
                    else
                        commandList->BindImage(dummyTexture.image, dummyTexture.sampler, 2, 29);
            ...
            void RayTracingHelper::DispatchHitClosest(Graphics::CommandList* commandList,
                ...
                if (binning) {
                    ...
                    // Order rays by their bins
                    {
                        ...
                        // rayBinCounterBuffer.ClearData(X_R32UI, GL_UNSIGNED_INT, &zero);
                    }
