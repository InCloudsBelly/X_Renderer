    ...
    namespace Renderer {
        ...
        namespace Helper {
            ...
            void VegetationHelper::PrepareInstanceBuffer(Scene::Vegetation& vegetation,
                ...
                {
                    auto pipelineConfig = PipelineConfig("Vege_InstanceCulling_Pipeline","vegetation/instanceCulling.csh");
                ...
                {
                    auto pipelineConfig = PipelineConfig("Vege_InstanceBinningOffset_Pipeline","vegetation/instanceBinningOffset.csh");
                    auto pipeline = PipelineManager::GetPipeline(pipelineConfig);
                ...
                {
                    auto pipelineConfig = PipelineConfig("Vege_InstanceBinning_Pipeline","vegetation/instanceBinning.csh");
                    auto pipeline = PipelineManager::GetPipeline(pipelineConfig);
                ...
                {
                    auto pipelineConfig = PipelineConfig("Vege_InstanceDrawCall_Pipeline","vegetation/instanceDrawCall.csh");
                    auto pipeline = PipelineManager::GetPipeline(pipelineConfig);
