    ...
    namespace Renderer {
        ...
        void ExampleRenderer::Init(Graphics::GraphicsDevice *device) {
...

            {
                ...
                auto pipelineConfig = PipelineConfig("ExampleTrianglePipeline", shaderConfig, pipelineDesc);
            ...
            {
                auto mesh = X::ResourceManager<X::Mesh::Mesh>::GetResourceWithLoader(
                    "sponza/sponza.obj", X::Loader::ModelLoader::LoadMesh, false, glm::mat4(1.0f), 2048
                );
                ...
                auto pipelineConfig = PipelineConfig("ExampleMeshPipeline", shaderConfig, pipelineDesc, { "MYMACRO" });
            ...
            }
            {
                ...
                auto pipelineConfig = PipelineConfig("ExampleComputePipeline", "example/compute.csh");
