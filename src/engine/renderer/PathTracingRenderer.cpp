...
namespace X {
    ...
    namespace Renderer {
        ...
        void PathTracingRenderer::Init(Graphics::GraphicsDevice *device) {
            ...
            rayGenPipelineConfig = PipelineConfig("PathTracer_RayGen_Pipeline", "pathtracer/rayGen.csh");
            rayHitPipelineConfig = PipelineConfig("PathTracer_RayHit_Pipeline", "pathtracer/rayHit.csh");
