#ifndef X_RENDERTARGET_H
#define X_RENDERTARGET_H
...
namespace X {
    ...
    public:
        ...
        explicit RenderTargetData(ivec2 resolution, bool useDepthFormat) {
            ...
            roughnessMetallicAoTexture = std::make_shared<Texture::Texture2D>(resolution.x, resolution.y,
                VK_FORMAT_R8G8B8A8_UNORM, Texture::Wrapping::ClampToEdge, Texture::Filtering::Linear);
            emissionTexture = std::make_shared<Texture::Texture2D>(resolution.x, resolution.y,
                VK_FORMAT_R8G8B8A8_UNORM, Texture::Wrapping::ClampToEdge, Texture::Filtering::Linear);
        ...
        void Resize(ivec2 resolution) {
            ...
            emissionTexture->Resize(resolution.x, resolution.y);
        ...
        Ref<Texture::Texture2D> emissionTexture = nullptr;
    ...
    public:
        ...
        Texture::Texture3D froxelInjectionGrid;
        Texture::Texture3D histroyFroxelInjectionGrid;
        Texture::Texture3D froxelScatteringGrid;
