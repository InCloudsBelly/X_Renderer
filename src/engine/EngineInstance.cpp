...
namespace X {
    ...
    EngineInstance::EngineInstance(const std::string& instanceName, int32_t windowWidth,
        int32_t windowHeight, int32_t flags, bool createMainRenderer) : window(instanceName, X_WINDOWPOSITION_UNDEFINED,
        X_WINDOWPOSITION_UNDEFINED, windowWidth, windowHeight, flags) {
