...
namespace X {
    ...
    namespace Input {
        ...
        ControllerHandler::~ControllerHandler() {
            ...
            X::Events::EventManager::ControllerAxisEventDelegate.Unsubscribe(
                controllerAxisEventHandle
            );
            X::Events::EventManager::ControllerButtonEventDelegate.Unsubscribe(
                controllerButtonEventHandle
            );
            X::Events::EventManager::ControllerDeviceEventDelegate.Unsubscribe(
        ...
        void ControllerHandler::ControllerDeviceEventHandler(Events::ControllerDeviceEvent event) {
            ...
            if (event.type == X_CONTROLLER_ADDED) {
            ...
            else if (event.type == X_CONTROLLER_REMOVED) {
